...
The Service uses **Unity Ads**, provided by Unity Technologies ApS.

Unity Ads may collect and process:
...
More information: https://unity.com/legal/privacy-policy
...
* **Unity Ads** (for advertising and monetization purposes)

Such sharing is strictly limited to what is necessary for service functionality.
...
We rely on third-party providers that implement appropriate safeguards in accordance with applicable data protection laws (e.g., GDPR compliance mechanisms).
...
Any data processed is retained by third-party providers (such as Unity Technologies) in accordance with their own data retention policies.
...
Please note that opting out will not remove ads, but will make them non-personalized.
...
Any changes will be reflected by updating the “Last Updated” date. Continued use of the Service constitutes acceptance of the updated policy.
...
The Service integrates third-party advertising services, including **Unity Ads**.
